...
public class SwaggerConfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder()
				.title("First REST Service with SpringBoot")
				.description("User services Demo - Add, Delete and find users")
				.version("1.0")
				.contact(new Contact("Lekhraj Dinkar", "https://github.com/lekhrajdinkar", "LekhrajDinkar@gmail.com"))
				.license("Apache 2.0")
